...
# Outside UPLOAD_DIR on purpose: /uploads is a public static mount, and
# nesting SCORM content under it would serve course files with no auth.
os.environ["SCORM_CONTENT_DIR"] = f"{_tmp}/scorm_content"
