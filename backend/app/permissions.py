...
MODULES = [
    ...
    ("reports", "Reports"),
    ("staff_leave", "Staff Leave & Substitution"),
    ("fee_concessions", "Fee Concessions"),
    ("gate_register", "Gate & Visitors"),
...
SYSTEM_ROLE_PERMISSIONS = {
    ...
    "Principal": {
        ...
        "hostel": "manage", "fees": "view", "accounting": "view",
        "alumni_withdrawals": "manage", "master_data": "view",
        "payroll": "view", "homework": "view", "online_tests": "view",
        "lms": "manage", "courses": "manage", "scorm": "manage",
        "discussions": "manage",
        "staff_leave": "manage", "fee_concessions": "view",
        "gate_register": "manage", "syllabus": "manage",
        "transport": "view", "vehicle_tracking": "view",
    },
    "Accounts": {
        "dashboard": "view", "fees": "manage", "accounting": "manage",
        "inventory": "view", "students": "view",
        ...
        "alumni_withdrawals": "view", "payroll": "manage",
        "fee_concessions": "manage",
    },
    "Teacher": {
        ...
        "compliance": "view", "homework": "manage", "online_tests": "manage",
        "lms": "manage", "courses": "manage", "scorm": "manage",
        "discussions": "manage",
        "staff_leave": "view", "gate_register": "view",
        "syllabus": "manage",
    },
    "Parent": {"portal": "view"},
    "Student": {"portal": "view"},
